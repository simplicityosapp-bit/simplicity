/* ════════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════════
   Shared verbatim with the web app: the store is pure JS — pub/sub, a
   timeout and i18n, no DOM — so the only platform-specific piece is the
   toast that renders it. Keep the two copies in step.
   ...
   (Ctrl/Cmd+Z, Ctrl/Cmd+Y) drives undo/redo on desktop; there is no
   keyboard here, so the toast button is the only way in.
