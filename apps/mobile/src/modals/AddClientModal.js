...
const styles = themed((c, t) => ({
  ...
  note: { fontSize: 12, color: c.textFaint, lineHeight: 17 },
  pills: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  pill: { flexGrow: 1, minWidth: 68, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 999, borderWidth: 1, borderColor: c.border, backgroundColor: c.cardFlat, alignItems: 'center' },
  ...
  acc: { borderWidth: 1, borderColor: c.border, borderRadius: 12, backgroundColor: c.cardFlat, overflow: 'hidden' },
  accHead: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 12, paddingHorizontal: 14 },
  accTitle: { flex: 1, fontSize: 14, fontWeight: '500', color: c.text },
  accBody: { paddingHorizontal: 14, paddingBottom: 14, gap: 12 },
  clearLink: { fontSize: 13, color: c.brand, alignSelf: 'flex-start' },
