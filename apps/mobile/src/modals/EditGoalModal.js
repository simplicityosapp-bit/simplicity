...
const styles = themed((c, t) => ({
  ...
  pill: { flexGrow: 1, minWidth: 64, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 999, borderWidth: 1, borderColor: c.border, backgroundColor: c.cardFlat, alignItems: 'center' },
