...
export default function HomeScreen() {
  ...
  const {
    ...
    tasks, goals, categories, sessions, members, reminders, entries, answers, questions, loading, error, refetch, addAnswer, addTask, addEntry, addTransaction,
  } = useHomeData()
  ...
  return (
    <Screen name="home">
      ...
      >
        ...
        {!loading ? <QuickRow goals={goals} categories={categories} addTask={addTask} addEntry={addEntry} addTransaction={addTransaction} /> : null}
