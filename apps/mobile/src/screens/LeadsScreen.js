...
const styles = themed((c, t) => ({
  ...
  viewBtnTextOn: { color: c.bg, fontWeight: '600' },
  panelIntro: { fontSize: 13, color: c.textSub, lineHeight: 18 },
  sgroup: { gap: 8 },
  sgroupTitle: { fontSize: 14, fontWeight: '600', color: c.text },
  ...
  chipEmpty: { fontSize: 12, color: c.textFaint },
  ...
  groupNote: { fontSize: 12, color: c.textFaint, lineHeight: 17 },
  ...
  stat: { flex: 1, alignItems: 'center', paddingVertical: 12, borderRadius: 16, backgroundColor: c.cardFlat, borderWidth: 1, borderColor: c.border },
  statNum: { fontSize: 20, fontWeight: '700', color: c.text },
  statLbl: { fontSize: 11, color: c.textFaint, marginTop: 2 },
  dot: { width: 10, height: 10, borderRadius: 5 },
  groupTitle: { fontSize: 14, fontWeight: '600', color: c.textSub, flex: 1 },
  ...
  colOver: { borderColor: c.positive, borderWidth: 1.5 },
  ...
  colHead: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingBottom: 10, marginBottom: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: c.divider },
  colDot: { width: 10, height: 10, borderRadius: 5 },
  colTitle: { fontSize: 14, fontWeight: '600', color: c.text, flex: 1 },
  colCount: { fontSize: 13, fontWeight: '600', color: c.textSub, backgroundColor: c.cardFlat, minWidth: 22, textAlign: 'center', borderRadius: 999, paddingVertical: 1, paddingHorizontal: 7, overflow: 'hidden' },
  colBody: { gap: 10 },
  colEmpty: { fontSize: 12, color: c.textFaint, textAlign: 'center', paddingVertical: 24 },

  opt: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 14, paddingHorizontal: 4, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: c.divider },
  ...
  bannerCount: { fontSize: 12, fontWeight: '700', color: c.onBrand, backgroundColor: c.amberWarn, minWidth: 20, textAlign: 'center', borderRadius: 999, paddingVertical: 1, paddingHorizontal: 6, overflow: 'hidden' },
  bannerText: { fontSize: 13, fontWeight: '500', color: c.text },

  fuEmpty: { fontSize: 13, color: c.textFaint, paddingVertical: 8 },
  fuRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: c.divider },
  fuOpen: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  fuName: { fontSize: 15, color: c.text, flex: 1 },
  fuDate: { fontSize: 13, color: c.textSub },
  fuIcon: { width: 34, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: c.cardFlat },
  fuDone: { width: 34, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: c.positive },
  ...
  filterBtnText: { fontSize: 13, color: c.textSub },
  filterBtnTextOn: { color: c.onBrand, fontWeight: '600' },
  ...
  clearBtn: { paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: c.border, alignItems: 'center', marginTop: 4 },
  clearText: { fontSize: 14, color: c.textSub },
}))
