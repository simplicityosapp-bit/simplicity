...
const HOME_TOUR = [
  { target: '[data-widget-id="moon"]',      title: 'מבט על',          body: 'הסתכלות מהירה על קצב ההתקדמות מול היעדים. המספר הגדול הוא קצב ההתקדמות, והקטן הוא האחוז הכללי מהיעד.' },
  { target: '[data-widget-id="insights"]',  title: 'שאלות יומיות',    body: 'השאלות שבחרת מופיעות כאן ומשקפות את ההתקדמות בכל רגע — ואפשר לעדכן מכאן בקלות כל יעד.' },
  { target: '[data-widget-id="quick-row"]', title: 'הוספה מהירה',     body: 'קיצור דרך לכל כפתורי ההוספה (משימות, הכנסות, לידים…). "עדכון יעד" מאפשר לעדכן יעדים שדורשים הזנה ידנית.' },
  { target: '[data-widget-id="attention"]', title: 'דרוש תשומת לב',   body: 'אישור פגישות שהתקיימו, תשלומים שאמורים להתקבל, ועוד דברים שלא כדאי שייפלו בין הכיסאות.' },
  { target: '[data-widget-id="reminders"]', title: 'תזכורות',         body: 'משימות שחוזרות על עצמן, וכל דבר שכדאי להיזכר בו במועד — כאן המקום.' },
  { target: '[data-widget-id="next-tasks"]',title: 'משימות',          body: 'המשימות הדחופות ביותר מופיעות כאן.' },
  { target: '[data-widget-id="chips"]',     title: 'כרטיסי מצב',      body: 'תצוגות מצב שאפשר להתאים אישית — לחיצה עליהן פותחת את הפירוט.' },
]
...
const CLIENTS_TOUR = [
  { target: '.c-tabs-row',    title: 'סטטוס הלקוחות', body: 'הלקוחות מחולקים לפי סטטוס: פעיל׊׉, ביניים (כאלה שקצת נעלמו) ולשעבר. הסטטוס נקבע אוטומטית לפי הפעילות, ותמיד אפשר לשנות ידנית.' },
...
const TASKS_TOUR = [
  { target: '.t-view',   title: 'משימות ותזכורות', body: 'משימות הן מטלות ללא תאריך. תזכורות הן כל מה שיש לו מועד — כאן עוברים ביניהם.' },
...
const FINANCE_TOUR = [
  ...
  { target: '.f-chart',     title: 'הכנסה מצטברת',    body: 'הקו מצטבר את ההכנסות יום אחר יום מול יעד ההכנסה החודשי (הקו המקווקו). ככה רואים אם הקצב נשמר.' },
