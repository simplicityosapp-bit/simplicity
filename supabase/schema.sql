...
CREATE POLICY community_mentions_insert_author ON public.community_message_mentions FOR INSERT TO authenticated
  ...
  WHERE ((m.id = community_message_mentions.message_id) AND (m.user_id = auth.uid()))))));
...
-- ════════════════════════════════════════════════════════════════
--  FUNCTIONS (signatures only; extension-owned functions excluded)
-- ════════════════════════════════════════════════════════════════
...
--   guard_immutable_columns() -> trigger  search_path=""
--   is_community_admin() -> boolean  search_path=""
--   is_reserved_display_name(p_name text) -> boolean  [SECURITY DEFINER]  search_path=""
